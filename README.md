...
- [**Do it! 쉽게 배우는 R 데이터 분석 데이터 분석**](http://www.kyobobook.co.kr/product/detailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9791187370949&orderClick=LAG&Kc=) & [**강의용 프리젠테이션 자료** at GitHub](https://github.com/youngwoos/Doit_R/tree/master/Lecture)
- [**R을 이용한 퀀트 투자 포트폴리오 만들기**](https://hyunyulhenry.github.io/quant_cookbook/)

첫 번째 책은 R을 처음 사용하는 이들이 쉽고 흥미롭게 R을 활용하는 단계까지 경험해볼 수 있게 안내합니다. 두 번째 책은 퀀트 투자하는 이들을 대상으로 쓰여졌지만, 8장 정도까지 읽으면 R을 사용해서 웹스크래핑/웹크롤링을 하는데 필요한 핵심적인 내용들을 익힐 수 있습니다.
